...
- Wasmi-backed WASI preview1 execution over Wanix task namespaces, fd tables, fd directory/positional I/O/allocation/advice/flags/timestamps/sync/truncate syscalls, and path mutation syscalls.
