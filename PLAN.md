...
- Attach real browser storage/import adapters and execution glue on top of the browser custom elements, Worker/MessagePort helpers, and host-neutral registries.
